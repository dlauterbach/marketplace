...
## IPFS Hash Storage
This DApp is storing IPFS hashes as type ```string``` in the contract.  This results in a substantial increase in the gas required to create a listing.  A more efficient method of storing an IPFS hash is presented [here](https://github.com/saurfang/ipfs-multihash-on-solidity).  Due to time constraints this approach was not implemented.